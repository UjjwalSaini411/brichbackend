"""
Django settings for brich project.
...
SECRET_KEY = 'django-insecure-2!bnia=px$#j^%j(r&55^k%!zfuk&e*zjsbry@bu_kxjr4ey4^'
...
WSGI_APPLICATION = 'brich.wsgi.application'
